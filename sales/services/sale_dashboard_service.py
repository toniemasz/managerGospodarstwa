    ...
    def get_dashboard_summary(self, date_from=None, date_to=None) -> dict:
        ...
        return {
            ...
            "stats": {
                ...
                "avg_price_per_kg": round(report["average_price_per_kg"], 2),
                "avg_weight_per_pig": round(report["average_slaughter_weight_per_pig"], 2),
                "avg_meatiness": round(report["average_meatiness"], 2) if report["average_meatiness"] is not None else None,
