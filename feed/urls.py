...
urlpatterns = [
    ...
    path('magazyn/gotowe-pasze/dodaj/', finished_feed_views.create_ready_feed_product_view, name='create_ready_feed_product'),
    path('magazyn/gotowe-pasze/<int:product_id>/dostawa/dodaj/', finished_feed_views.add_ready_feed_delivery_view, name='add_ready_feed_delivery'),
