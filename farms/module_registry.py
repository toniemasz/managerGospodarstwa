...
MODULE_DEFINITIONS = (
    ...
    {"key": "inventory", "title": "Magazyn", "url_name": "feed_inventory", "group": "feed", "icon": "Mg", "icon_name": "warehouse", "tone": "amber", "description": "Surowce, gotowe pasze, podania i ruchy magazynowe.", "active_urls": ("feed_inventory", "feed_full_inventory", "add_delivery", "edit_delivery", "inventory_adjustment", "finished_feed_inventory", "create_ready_feed_product", "add_ready_feed_delivery", "feed_servings", "create_feed_serving")},
