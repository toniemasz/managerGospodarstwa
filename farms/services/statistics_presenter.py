    ...
    def _sows_section(cls, data):
        ...
        return {
            "section_cards": [
                ...
                cls.card("Przyjęte do odchowu", values["piglets_received"], "szt."),
                cls.card("Przekazane z odchowu", values["piglets_transferred"], "szt."),
                cls.card("Średnio żywych/miot", values["average_born_alive_per_litter"], "szt."),
                cls.card("Odsadzone", values["weaned"], "szt."),
                cls.card("Średnio odsadzonych/odchów", values["average_weaned_per_litter"], "szt.", "Wynik maciory odchowującej"),
